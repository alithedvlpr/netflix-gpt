          ...
          <div className="mx-auto max-w-7xl px-2 lg:px-0">
            <div className="mx-auto  max-w-3xl md:text-center">
              ...
              <p className="mx-auto p-4 rounded-lg mt-4 max-w-2xl text-left border-2 border-brand-pink text-xl text-brand-pink">
                ...
                intelligence and natural language processing to enhance the
                Netflix streaming experience. This innovative application
                seamlessly integrates the capabilities of GPT-3.5, offering
                users a personalized, engaging, and interactive way to explore
                and enjoy their favorite shows and movies on Netflix.
              </p>
            </div>
